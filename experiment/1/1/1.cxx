...
bool tonghua() {
    return cs[0].hs == cs[1].hs && cs[1].hs == cs[2].hs && cs[2].hs == cs[3].hs &&
           cs[3].hs == cs[4].hs;
}
bool sandaier() {
    if (cs[1] == cs[2])
...
bool santiao() {
    return (cs[0] == cs[1] && cs[1] == cs[2]) || (cs[1] == cs[2] && cs[2] == cs[3]) ||
           (cs[2] == cs[3] && cs[3] == cs[4]);
}
bool liangdui() {
    return (cs[0] == cs[1] && (cs[2] == cs[3] || cs[3] == cs[4])) ||
           (cs[1] == cs[2] && cs[3] == cs[4]);
}
bool yidui() {
    return cs[0] == cs[1] || cs[1] == cs[2] || cs[2] == cs[3] || cs[3] == cs[4];
}
bool tonghuasun() {
